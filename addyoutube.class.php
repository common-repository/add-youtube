...
class AddYouTube
{
	...
	{
	    add_options_page('Add YouTube options', 'Add YouTube', 8, __FILE__, array($this, 'options_page'));
	}
	...
	function options_page()
	{
		...
		*/	
    	...
    	{			
    		check_admin_referer('add-youtube');		
            ...
            $msg_status = 'Add YouTube options saved.';
	 	...
	 	<div id="mainblock" style="width:710px">
			<div class="dbx-content">			
    			...
    			<div id="usage" style="display:none">
                    ...
                    <p>Add YouTube also supports migrated blogs from Wordpress.com using [youtube=youtubeadresss]</p>
...
<div>
			...
			<a v-width="960" v-height="745" href="#">
			 ...
			 <a v-width="1280" v-height="745" href="#">
                    ...
                    <p>Use this option if you have used another youtube plugin and switched over to Add YouTube.<p>
                    ...
                    <p class="instruct">Some RSS feed readers like Bloglines will show embeded YouTube videos. Some will not and Add YouTube allows you to display a video link and a video screenshot instead.</p>
                    <p class="instruct">Add YouTube will always embed the video but it can not know if the reader supports embeded video or not. So use these additional options at your own likening.</p>
...
<h5 class="author">Another fine WordPress plugin by <a href="http://www.escalateseo.com">EscalateSEO</a></h5>
END;
	}
	

	/**
    * Looks for Add YouTube URL(s) in the post content
...
EOT;
    ...
    function install()
    {
        ...
        {
            register_sidebar_widget('Add YouTube', array($this, 'widget'));
        }    
        
        if (function_exists('register_widget_control'))
        {    
            register_widget_control('Add YouTube', array($this, 'widget_control'));
        }
      ...
      /*  
        ...
        {
            if (false !== $old_option = get_option("add_yt_$key"))
            {
                $this->options[$key] = $old_option;
            }
            
            delete_option("add_yt_$key");
        }
...
EOT;
    ...
    function check_plugin_version($plugin)
    {
        ...
        if (strpos($plugin, 'addyoutube.php') === false) return;
...
EOT;
    ...
    function get_info()
    {
        $checkfile = 'http://www.wordpress.org';
